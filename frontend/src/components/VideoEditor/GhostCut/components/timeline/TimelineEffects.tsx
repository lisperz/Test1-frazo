...
export const TimelineEffects: React.FC<TimelineEffectsProps> = ({
  timelineEffects,
  duration,
  currentTime,
  timelineZoom,
    ...
    >
      ...
      >
        <Box
          sx={{
            position: 'relative',
            height: `${Math.max(50, timelineEffects.length * TIMELINE_CONFIG.TRACK_HEIGHT)}px`,
            width: '100%',
          }}
        >
          {timelineEffects.map((effect, index) => {
            const trackTop = index * TIMELINE_CONFIG.TRACK_HEIGHT + TIMELINE_CONFIG.TRACK_MARGIN;
            ...
            return (
              <Box
                ...
                sx={{
                  ...
                  width: `${effectWidth}%`,
                  top: `${trackTop}px`,
                  height: `${TIMELINE_CONFIG.EFFECT_HEIGHT}px`,
